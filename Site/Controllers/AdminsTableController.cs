...
public class AdminsTableController : PermissionNeededController
{
    ...
    public async Task<IActionResult> Details(Guid? id)
    {
        ...
        if (id == null || _context.Admins == null) return NotFound();
    ...
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(Guid id,
        [Bind("AdminId,UserId,IsActual,CreatedUTC,UpdatedUTC")]
        Admin admin)
    {
        if (!isAdmin()) return KickAction();
    ...
    public async Task<IActionResult> DeleteConfirmed(Guid id)
    {
        ...
        if (_context.Admins == null) return Problem("Entity set 'BashLearningContext.Admins'  is null.");
